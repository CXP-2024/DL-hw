"""Evaluate GM-VAE with FID and diversity metrics.

Logic mirrors evaluate_fid.py but imports from modules.gmvae.
"""
import logging
...
def main() -> None:
    ...
    mean_fid, per_digit_fid, per_digit_std = evaluate(
        model, feature_extractor, dataset, args.generate,
    )
...
def evaluate(
    ...
    output_root = Path("generated") / "gmvae"
